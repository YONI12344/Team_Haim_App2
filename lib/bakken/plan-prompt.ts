...
export interface BlockRequest {
  ...
  seasonStartDate: string // yyyy-MM-dd — day 1 of the whole season/journey (stages[0].startDate); this is the week-1 anchor, see rule 3

...
16. FARTLEK VARIETY — rotate between at least two distinct fartlek styles across the season instead of repeating the same one: (a) the 45/15 micro-interval style (title "Fartlek 45/15" or similar, per rule 12/the intervals[] guidance), and (b) a "Kenyan Fartlek" — longer alternating hard/easy segments (e.g. 8-10 reps of 1 minute hard / 1 minute easy jog, expressed via intervals[] as an alternating sequence per rule mechanics for intervals[]), titled "Kenyan Fartlek" — a well-known unstructured speed-play style, still grounded in workout_mechanics_and_first_principles for the actual effort/lactate targets you assign it. Use whichever fits the phase and vary it block to block for stimulus variety, same as any other quality session type.

...
export interface BlockStageInfo {
  ...
  dayTypeTemplate?: Partial<Record<'sunday' | 'monday' | 'tuesday' | 'wednesday' | 'thursday' | 'friday' | 'saturday', string>>
}

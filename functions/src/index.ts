...
export const syncLogToSheets = functions.firestore
  .document('logs/{logId}')
...
export const syncWorkoutToSheets = functions.firestore
...
export const syncProfileToSheets = functions.firestore
...
export const syncGoalsToSheets = functions.firestore
...
export const syncAllAthletesNow = functions.https.onCall(async (_data, context) => {
  if (!context.auth) {

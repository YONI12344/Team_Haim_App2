      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            אימונים אמיתיים שכתבתם, מאורגנים לפי רמת ספורטאי ושלב התקדמות. עוזר המאמן AI בוחר ומתאים משך/מרחק מתוכם במקום להמציא תוכן — ככל שיש יותר גרסאות לכל סוג, כך פחות חזרתיות. השתמשו בסמל התיקייה על כל אימון כדי להעביר אותו במהירות בין רמות/שלבים.
          </p>
        </div>

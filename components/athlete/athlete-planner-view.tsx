                        ...
                        <div key={w.id} className="space-y-3 rounded-xl border border-border p-3">
                          ...
                          {w.workout.sets && w.workout.sets.length>0 && (
                            <div className="space-y-2">
                              <p className="text-xs font-semibold text-navy uppercase tracking-wide">סטים / אינטרוולים</p>
                                ...
                                <div key={set.id||si} className="rounded-lg border border-border overflow-hidden">
                                  <div className="bg-muted/50 px-3 py-2 flex items-center justify-between">
                                    <span className="text-xs font-semibold text-navy">
                                      סט {si+1} — {set.reps}× {set.distance||set.duration||''}
                                      {set.pace && <span className="font-normal text-muted-foreground"> @ {set.pace}</span>}
                                    </span>
                                    {set.rest && <span className="text-xs text-muted-foreground">מנוחה: {set.rest}</span>}
                                  </div>

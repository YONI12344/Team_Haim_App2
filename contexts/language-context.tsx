...
const translations: Record<Language, Translations> = {
  en: {
    ...
    restBetweenReps: 'Rest between reps',
    setsLabel: 'Sets',
    repLabel: 'Round',
    ...
    continueToNext: 'No rest set — go straight to next set',
    dayView: 'Day',
    weekView: 'Week',
    monthView: 'Month',
    ...
    bankLevelHint: 'Adds this workout to the Workout Bank for the chosen level — Assistant Coach AI can pick and scale it instead of inventing new content.',
  ...
  he: {
    ...
    restBetweenReps: 'מנוחה בין חזרות',
    setsLabel: 'סטים',
    repLabel: 'חזרה',
    ...
    continueToNext: 'אין מנוחה מוגדרת — ישר לסט הבא',
    dayView: 'יום',
    weekView: 'שבוע',
    monthView: 'חודש',
    ...
    bankLevelHint: 'מוסיף את האימון הזה לבנק האימונים עבור הרמה שנבחרה — עוזר המאמן AI יוכל לבחור ולהתאים אותו במקום להמציא תוכן חדש.',
